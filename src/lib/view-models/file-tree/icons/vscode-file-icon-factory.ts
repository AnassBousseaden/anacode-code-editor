...
const VSCODE_ICON_MAP: Record<VSCodeFileIconName, { light: string; dark: string }> = {
	...
	csv: { light: 'file-type-csv', dark: 'file-type-csv' },
	...
	lock: { light: 'file-type-lock', dark: 'file-type-lock' },
	readme: { light: 'file-type-readme', dark: 'file-type-readme' },
	license: { light: 'file-type-license', dark: 'file-type-license' },
	image: { light: 'file-type-image', dark: 'file-type-image' },
	pdf: { light: 'file-type-pdf', dark: 'file-type-pdf' },
	...
	dart: { light: 'file-type-dart', dark: 'file-type-dart' },
